    ...
    <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/90 backdrop-blur">
      <div className="section-shell flex items-center justify-between py-4">
        ...
        <nav className="hidden items-center gap-7 text-xs font-semibold text-slate-500 md:flex">
          ...
          <a href="#steps" className="transition hover:text-ink">
            How it Works
          </a>
          ...
          <a href="#cart">
            {" "}
            <button onClick={onOpenCart} className="transition hover:text-ink">
        ...
        <button
          onClick={onOpenCart}
          className="rounded-full bg-brand px-4 py-2 text-xs font-semibold text-white shadow-sm transition hover:opacity-95"
        >
          Get Started
        </button>
      </div>
